...
Invoke-RestMethod -Method POST -Uri 'http://127.0.0.1:8080/api/v24.7/test-access/revoke' -Headers $headers -Body (@{email=$TesterEmail} | ConvertTo-Json) -ContentType 'application/json' | Out-Null
